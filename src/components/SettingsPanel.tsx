                    ...
                    {isAdmin && (
                      <div className="dashboard-card">
                        <div className="dashboard-card-content space-y-2">
                          ...
                          <div className="flex gap-2">
                            <Input name="inviteEmail" className="h-9" placeholder={t('inviteEmailPlaceholder')} type="email" value={inviteEmail} onChange={(e) => setInviteEmail(e.target.value)} onKeyDown={(e) => e.key === 'Enter' && handleInvite()} />
