...
export const en: Record<TranslationKey, string> = {
  ...
  leaveFamilyConfirm: 'Are you sure you want to leave?',
  leaveFamilyWarning: 'You will lose access to all budget data from this family. To return, an administrator will need to send you a new invitation.',
