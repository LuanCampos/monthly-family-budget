...
export const en: Record<TranslationKey, string> = {
  ...
  goalStatusArchived: 'Completed/Inactive',
  goalArchivedInfo: 'Archived goal. New expenses will not be linked automatically.',
  goalMarkComplete: 'Mark as completed',
  ...
  editEntryForGoal: 'Editing entry for {{goal}}',
  perMonth: 'mo',
  deadline: 'Deadline',
  month: 'month',
  months: 'months',
