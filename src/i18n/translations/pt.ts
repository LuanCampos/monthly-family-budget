export const pt = {
  ...
  leaveFamilyConfirm: 'Tem certeza que deseja sair?',
  leaveFamilyWarning: 'Você perderá acesso a todos os dados de orçamento desta família. Para voltar, será necessário que um administrador envie um novo convite.',
