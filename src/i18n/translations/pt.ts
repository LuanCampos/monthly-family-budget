export const pt = {
  ...
  leaveFamilyWarning: 'Você perderá acesso ao orçamento desta família.',
  deleteFamilyConfirm: 'Excluir família?',
  deleteFamilyWarning: 'Esta ação é irreversível. Todos os dados do orçamento serão perdidos.',
